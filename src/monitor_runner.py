...
from src.monitor.matcher import build_buckets, find_valid_pair, parse_date, normalize_city
from src.monitor.notifier import log_slots_for_analysis, send_slack, format_slack_message
...
def load_customers():
    ...
    for entry in raw:
        ...
        ofc_cities = entry["ofcCities"]
        consular_cities = entry["consularCities"]
        ofc_start = entry["ofcStartDate"]
        ofc_end = entry["ofcEndDate"]
